...
public class CollectTweetsCostco {
...
Twitter twitter = new TwitterFactory().getInstance();
 ...
 private CollectTweetsCostco(String keyword){
	 ...
	 public void getTweetCostco(boolean loadRecords, String keyword) {        
             ...
             try {
                 ...
                 for (Status tweet : tweets) {
                     ...
                     basicObj.put("tweet_date", tweet.getUser().getCreatedAt().toString().substring(8,10));
                     basicObj.put("tweet_month", tweet.getUser().getCreatedAt().toString().substring(4,7));
                     basicObj.put("tweet_year", tweet.getUser().getCreatedAt().toString().substring(24));       
                     basicObj.put("tweet_timeStamp", tweet.getUser().getCreatedAt());
...
public static void main(String[] args){
	  new CollectTweetsCostco("CostcoTwitterTest").getTweetCostco(true, "Costco");
	  //new CollectTweetsCostco("CostcoTwitter").getTweetCostco(true, "@CostcoTweets"); //official Twitter Page 
	}
